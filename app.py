...
loaded_model = pickle.load(open('C:/Users/melih/Desktop/Data Science(Yapay Zeka)/Deploying machine learning model with spyder/Heart Attack Web App using Streamlit/trained_model.sav','rb'))
